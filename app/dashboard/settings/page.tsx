...
function SettingsPageContent() {
    ...
    const [subscriptionData, setSubscriptionData] = useState<{ subscription?: { status?: string; periodEnd?: string }; isPro?: boolean } | null>(null)
    ...
    useEffect(() => {
        ...
        if (searchParams.get('success') === 'annual') {
            ...
            setTimeout(() => setShowAnnualSuccess(false), 5000)
        }
    ...
    const trialEnd = subscriptionData?.subscription?.periodEnd ? new Date(subscriptionData.subscription.periodEnd) : null
    ...
    return (
        <div className="space-y-6">
            ...
            {showAnnualSuccess && (
                <div className="p-4 bg-green-50 border border-green-200 rounded-lg">
                    <div className="flex items-center gap-2">
                        ...
                        <div>
                            <h4 className="font-semibold text-green-900">✓ Switched to annual billing</h4>
                            <p className="text-green-800 text-sm">
                                You&apos;re now on the Pro Annual plan. Next charge: {new Date(Date.now() + 365 * 24 * 60 * 60 * 1000).toLocaleDateString()}.
                                You&apos;re saving $58/year!
                            </p>
                        </div>
                    </div>
                </div>
                        ...
                        <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
                            <div className="flex items-start gap-3">
                                ...
                                <div className="flex-1">
                                    <h4 className="font-semibold text-blue-900">💡 Save $58/year with annual billing</h4>
                                    <p className="text-blue-700 text-sm mt-1">
                                        Switch to annual and pay ${SUBSCRIPTION_PRICING.PRO_ANNUAL.price / 100}/year instead of ${SUBSCRIPTION_PRICING.PRO_MONTHLY.price / 100}/month.
                                    </p>
                                    <Button
                                        ...
                                        size="sm"
                                    >
                                        Switch to Annual (${SUBSCRIPTION_PRICING.PRO_ANNUAL.price / 100}/year)
                                    </Button>
                                </div>
                            </div>
                        </div>
            ...
            <Dialog open={showCancelDialog} onOpenChange={setShowCancelDialog}>
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Are you sure you want to cancel your subscription? You&apos;ll be redirected to Stripe&apos;s secure billing portal to complete the cancellation.
                        </DialogDescription>
                    </DialogHeader>
                    <DialogFooter>
                ...
                <DialogContent>
                    ...
                    <div className="space-y-4">
                        <RadioGroup value={cancelReason} onValueChange={setCancelReason}>
                            ...
                            <div className="flex items-center space-x-2">
                                <RadioGroupItem value="missing-features" id="missing-features-retention" />
                                <Label htmlFor="missing-features-retention">Missing features</Label>
                            </div>
                            <div className="flex items-center space-x-2">
                    ...
                    <DialogFooter>
                        <Button onClick={handleRetentionSubmit}>
                            Continue
                        </Button>
                    </DialogFooter>
                </DialogContent>
            ...
            <Dialog open={showSaveOffer} onOpenChange={setShowSaveOffer}>
                <DialogContent>
                    <DialogHeader>
                        <DialogTitle>Before you go... we can work something out</DialogTitle>
                    </DialogHeader>
                    <div className="space-y-4">
                        {offerType === 'discount' && (
                            <div className="p-4 bg-blue-50 rounded-lg">
                                <h4 className="font-semibold text-blue-900">50% off for 3 months</h4>
                                <p className="text-blue-700">Keep your Pro features at half price for the next 3 billing cycles.</p>
                            </div>
                        )}
                        {offerType === 'pause' && (
                            <div className="p-4 bg-green-50 rounded-lg">
                                <h4 className="font-semibold text-green-900">Pause for 3 months</h4>
                                <p className="text-green-700">Keep all your data and features, but pause billing for 3 months. Perfect if you&apos;re taking a break.</p>
                            </div>
                        )}
                        <div className="flex gap-2">
                            <Button onClick={handleAcceptOffer} className="flex-1">
                                {offerType === 'discount' ? 'Accept 50% Off' : 'Accept Pause Offer'}
                            </Button>
            ...
            <Dialog open={showConfirmation} onOpenChange={setShowConfirmation}>
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Your subscription has been canceled. You can continue using Pro features until {trialEnd?.toLocaleDateString()}.
                        </DialogDescription>
                    </DialogHeader>
                    <div className="space-y-4">
